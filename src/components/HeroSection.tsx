    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto px-4 py-20 sm:py-28 text-center">
        ...
        <a
          ...
          className="inline-block bg-purple-primary hover:bg-purple-hover text-white font-extrabold text-lg sm:text-xl px-10 py-5 rounded-xl transition-colors mb-4"
          style={{ boxShadow: "0 0 40px rgba(164,53,240,0.4)" }}
        >
          Get Discount on Udemy →
        </a>

        <p className="text-xs text-gray-300 mb-10">
          ডুয়াল কারেন্সি কার্ড থাকলে উপরের লিঙ্কে ক্লিক করে ডিস্কাউন্টে কোর্স কিনুন!!
        </p>

        {/* Divider */}
        <div className="flex items-center gap-4 max-w-xs mx-auto mb-6">
          <div className="flex-1 h-px bg-white/15" />
          <span className="text-xs text-gray-100 font-medium whitespace-nowrap uppercase tracking-wider">
        ...
        {/* No-card path */}
        <div className="border border-white/10 bg-white/5 rounded-2xl p-5 max-w-sm mx-auto backdrop-blur-sm">
          <p className="text-sm text-gray-300 mb-2 font-medium">
            আমাদের মেসেজ করলে আপনার হয়ে আমরা কোর্স কিনে দেওয়ার ব্যাবস্থা করবো!
          </p>
          ...
          <p className="text-xs text-gray-300 mt-3">
            বিকাশ/নগদ/রকেট দিয়ে কোর্স কিনুন!!
          </p>
        </div>

        {/* Bottom trust strip */}
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-1 mt-10 text-xs text-gray-500">
